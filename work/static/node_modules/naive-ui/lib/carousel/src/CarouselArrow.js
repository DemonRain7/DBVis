...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props) {
        ...
        const { isVertical, isPrevDisabled, isNextDisabled, prev, next } = (0, CarouselContext_1.useCarouselContext)();
        return {
    ...
    render() {
        ...
        return ((0, vue_1.h)("div", { class: `${mergedClsPrefix}-carousel__arrow-group` },
            (0, vue_1.h)("div", { class: [
